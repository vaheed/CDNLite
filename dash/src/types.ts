...
export interface RateLimitRule { requests_per_minute: number; priority?: number; path_prefix?: string; key_type?: 'ip' | 'ip_path' | string; action?: string; }
...
export interface UsageSummary { site_id?: Id; bucket?: UsageBucket; total_requests?: number; requests?: number; bytes_in?: number; bytes_out?: number; records?: number; cache_hit_ratio?: number; points?: Array<Record<string, unknown>>; }
