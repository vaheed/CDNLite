...
import{computed,onMounted,ref}from'vue';import{RouterLink}from'vue-router';import StatusBadge from'@/components/ui/StatusBadge.vue';import ReportExportButton from'@/components/reports/ReportExportButton.vue';import RecommendationsPanel from'@/components/recommendations/RecommendationsPanel.vue';import{overviewApi}from'@/lib/api/overview';import{formatBytes,formatPercent}from'@/lib/utils/format';import type{Overview,OverviewWarning}from'@/types';
...
const reportData=computed(()=>({metrics:overview.value,warnings:warnings.value}));
