<template>
  <section class="space-y-6">
    ...
    <div v-else class="card overflow-x-auto"><table class="w-full text-left text-sm"><thead class="table-head"><tr><th>Time</th><th>Actor</th><th>Action</th><th>Resource</th><th>Domain</th><th></th></tr></thead>
