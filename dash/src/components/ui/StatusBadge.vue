...
const classes = computed(() => {
  ...
  if (['critical', 'expired', 'offline', 'failed', 'error'].includes(status)) return 'bg-red-50 text-red-700 ring-red-200 dark:bg-red-400/10 dark:text-red-200 dark:ring-red-300/20';
