...
const classes = computed(() => {
  ...
  if (['warning', 'stale', 'pending'].includes(status)) return 'bg-amber-50 text-amber-700 ring-amber-200 dark:bg-amber-400/10 dark:text-amber-200 dark:ring-amber-300/20';
