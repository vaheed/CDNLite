...
body="{\"edge_id\":\"${EDGE_ID}\",\"hostname\":\"${EDGE_HOSTNAME}\",\"public_ip\":\"${public_ip}\",\"region\":\"${EDGE_REGION}\",\"country\":\"${EDGE_COUNTRY:-}\",\"continent\":\"${EDGE_CONTINENT:-}\",\"version\":\"${EDGE_VERSION}\",\"config_version\":${config_version},\"health_status\":\"healthy\"}"
