        ...
        return [
            ...
            'protect_api' => [
                ...
                'rules' => [
                    ...
                    ['rule_table' => 'waf_rules', 'template_key' => 'waf_api_method_probe', 'payload' => ['enabled' => true, 'name' => 'Log suspicious API method probes', 'priority' => 70, 'type' => 'method_is', 'pattern' => 'TRACE', 'action' => 'log', 'description' => 'Generated by API Shield to surface unusual API method probes before blocking.']],
                ],
            ],
            'smart_rate_limiting' => [
            ...
            'bot_shield' => [
                ...
                'mode' => 'recommended',
                'rules' => [
                    ['rule_table' => 'waf_rules', 'template_key' => 'waf_bot_user_agents', 'payload' => ['enabled' => true, 'name' => 'Block obvious scraper user agents', 'priority' => 55, 'type' => 'user_agent_contains', 'pattern' => 'python-requests', 'action' => 'block', 'description' => 'Generated by Bot Shield for common automation clients.']],
                    ['rule_table' => 'waf_rules', 'template_key' => 'waf_fake_search_bots', 'payload' => ['enabled' => true, 'name' => 'Log suspicious search bot claims', 'priority' => 56, 'type' => 'user_agent_contains', 'pattern' => 'Googlebot', 'action' => 'log', 'description' => 'Generated by Bot Shield as a log-only fake bot signal until verified bot checks are configured.']],
                ],
            ],
            'wordpress_hardening' => [
                ...
                'mode' => 'recommended',
                'rules' => [
                    ['rule_table' => 'waf_rules', 'template_key' => 'waf_wordpress_xmlrpc', 'payload' => ['enabled' => true, 'name' => 'Log XML-RPC abuse probes', 'priority' => 42, 'type' => 'path_prefix', 'pattern' => '/xmlrpc.php', 'action' => 'log', 'description' => 'Generated by WordPress Hardening as a log-only XML-RPC abuse signal before blocking.']],
                    ['rule_table' => 'waf_rules', 'template_key' => 'waf_wordpress_scanners', 'payload' => ['enabled' => true, 'name' => 'Block WordPress scanner paths', 'priority' => 43, 'type' => 'path_contains', 'pattern' => 'wp-config.php', 'action' => 'block', 'description' => 'Generated by WordPress Hardening for high-confidence WordPress scanner paths.']],
                ],
            ],
            'checkout_protection' => [
                ...
                'rules' => [
                    ...
                    ['rule_table' => 'waf_rules', 'template_key' => 'waf_checkout_method_probe', 'payload' => ['enabled' => true, 'name' => 'Log unusual checkout methods', 'priority' => 44, 'type' => 'method_is', 'pattern' => 'TRACE', 'action' => 'log', 'description' => 'Generated by Checkout Protection to surface unusual checkout method probes before blocking.']],
                ],
            ],
            'emergency_protection' => [
                ...
                'rules' => [
                    ...
                    ['rule_table' => 'waf_rules', 'template_key' => 'waf_emergency_scanners', 'payload' => ['enabled' => true, 'name' => 'Block emergency scanner traffic', 'priority' => 6, 'type' => 'user_agent_contains', 'pattern' => 'nikto', 'action' => 'block', 'description' => 'Generated by Emergency Protection for active incident response.']],
                ],
            ],
