...
metric_line='{"ts":1,"domain_id":"domain-1","edge_node_id":"edge-1","requests_count":1,"bytes_in":2,"bytes_out":3,"status":200,"client_ip":"203.0.113.10","client_country":"IR"}'
...
assert items[0].get("client_ip") == "203.0.113.10"
