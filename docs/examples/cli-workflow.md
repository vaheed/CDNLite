...
```bash
php core/artisan cdn:site:create --name=CLI-Demo --domain=cli-demo.local --origin_host=core --origin_port=8080
php core/artisan cdn:site:list
php core/artisan cdn:site:update --id=11111111-1111-4111-8111-111111111111 --name=CLI-Demo-Updated
```
...
```bash
php core/artisan cdn:site:update --id=11111111-1111-4111-8111-111111111111 --proxy_enabled=0
php core/artisan cdn:site:update --id=11111111-1111-4111-8111-111111111111 --proxy_enabled=1
```
...
```bash
php core/artisan cdn:usage:ingest --site_id=11111111-1111-4111-8111-111111111111 --edge_node_id=edge-local-1 --requests_count=10 --bytes_in=1000 --bytes_out=5000 --status=200 --idempotency_key=cli-1
...
php core/artisan cdn:site:delete --id=11111111-1111-4111-8111-111111111111
```
