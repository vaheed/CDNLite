...
curl -i -H 'Host: unknown.local' http://localhost:8081/api/v1/domains
```
...
```bash
curl -s http://localhost:8080/api/v1/domains/11111111-1111-4111-8111-111111111111/dns/records | jq
curl -s -X PATCH http://localhost:8080/api/v1/domains/11111111-1111-4111-8111-111111111111/dns/records/22222222-2222-4222-8222-222222222222 -H 'Content-Type: application/json' -d '{"ttl":120}' | jq
...
```bash
php core/artisan cdn:usage:ingest --domain_id=11111111-1111-4111-8111-111111111111 --edge_node_id=edge-local-1 --requests_count=10 --bytes_in=1000 --bytes_out=5000 --status=200 --idempotency_key=ops-1
